...
<body>
    ...
    <nav id="navigation" class="navbar navbar-expand-lg">
        <div class="container">
          ...
          <!-- <picture> -->
            <a id="Heading" class="nav-link text-dark" href="#index.php"><img src="./img/logo.png" style="width: 30%; height: 30%;" alt="Logo"><strong>CreativByte</strong></a>
          <!-- </picture> -->
          <ul class="navbar-nav">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-primary px-4 smooth-scroll" href="#login.php"><strong>Log in</strong></a>
            </li>
            <li class="nav-item">
